...
function MovieForm({
  ...
  const [values, setValues] = useState(() =>
    normalizeInitialMovie(initialMovie),
  );
  ...
  return (
    <form
      ref={formRef}
      className="movie-form movie-admin-form"
      onSubmit={handleSubmit}
      noValidate
    >
      {submitError && (
        <div className="movie-alert movie-alert-error">{submitError}</div>
      )}
      ...
      <section className="form-panel movie-form-section">
        ...
        <div className="movie-genre-section">
          {genreError && (
            <div className="movie-alert movie-alert-error">{genreError}</div>
          )}
          <div className="genre-options movie-genre-options">
            {genres.map((genre) => (
              <label key={genre.id} className="checkbox-pill">
                ...
                />
                <span>
                  {values.genreIds.includes(genre.id) ? "✓ " : ""}
                  {genre.name}
                </span>
              </label>
            ))}
      ...
      <section className="form-panel movie-form-section movie-media-section">
        <div className="panel-heading">
