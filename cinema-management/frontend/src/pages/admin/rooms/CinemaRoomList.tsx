    ...
    <main className="app-shell room-admin-page room-list-page">
      <header className="room-page-header">
        <div>
          ...
          <p>Xem danh sách phòng và cấu hình loại ghế</p>
        </div>
      </header>
      ...
      <section className="room-toolbar" aria-label="Tìm kiếm và lọc phòng chiếu">
        ...
        <button type="button" className="secondary-button room-reset-button" disabled={!hasActiveFilter} onClick={handleResetFilters}>
          Đặt lại
        </button>
      </section>
